...
<pre>{`
\`\`\`yml
description: "this is \\[an escaped link](docs.konpyutaika.com)"
\`\`\`
`}</pre>
            <CodeBlock>
description: "this is \[an escaped link](docs.konpyutaika.com)"
            ...
            <div className='section' style={{marginTop: '40px'}}>
                <h1>Changelog</h1>
<pre>{`<Changelog>
    <p>This functionality has changed in konpyutaika v0.15.0</p>
</Changelog>
`}</pre>
                <Changelog>This functionality has changed in konpyutaika v0.15.0</Changelog>
            </div>
            <div className='section' style={{marginTop: '40px'}}>
                <h1>Collapsible</h1>
...
<pre>{`<FAQ src='Troubleshooting/sql-errors' alt_header="a header" />`}</pre>
            ...
            <div className='section' style={{marginTop: '40px'}}>
                <h1>File</h1>
<pre>{`<File name="~/.konpyutaika/profiles.yml">
...
`}</pre>
                <File name="~/.konpyutiaka/profiles.yml">
                    <pre>
                        password: hunter2
                    </pre>
                </File>
            ...
            <div className='section' style={{marginTop: '40px'}}>
                <h1>Lightbox</h1>
                <pre>{`<Lightbox src="/img/konpyutaika-logo.png" title="The Konpyutaika logo" />`}</pre>
                <Lightbox src="/img/konpyutaika-logo.png" title="The Konpyutaika logo" />
            </div>
