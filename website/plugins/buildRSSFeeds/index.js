...
const siteUrl = 'https://docs.konpyutaika.com'
...
module.exports = function buildRSSFeedsPlugin(context, options) {
  return {
    ...
    async loadContent() {
      ...
      const releaseNotesDirectory = 'docs/docs/versions/release-notes'
...
function getLink(data) {
  ...
  // For example, the path: docs/versions/konpyutaika-release-notes/12-January-2022
  // is converted to docs/versions/konpyutaika-release-notes/January-2022
